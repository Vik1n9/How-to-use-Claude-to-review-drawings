...
#
# Chinese default is "Iansui" (Traditional Chinese, github.com/ButTaiwan/iansui,
# SIL OFL). This script does not fetch it: install it system-wide yourself and
# fontconfig resolves it the same way it resolves the fonts below. TsangerJinKai02
# stays as the auto-fetched fallback for machines without Iansui installed.
