...
/* Chinese */
font-family: "Iansui", "TsangerJinKai02", "Source Han Serif SC",
...
If the output shows `DejaVuSerif` / `Bitstream Vera` - your specified font didn't load, fell through to system ultimate fallback. Expected: `Charter`, `Georgia`, `Iansui`, `TsangerJinKai02`, or a Japanese Mincho face such as `YuMincho`, `Hiragino-Mincho`, `Noto-Serif-CJK-JP`, or `Source-Han-Serif-JP`.
...
text { font-family: Charter, Georgia, "Iansui", "TsangerJinKai02", "Songti SC", serif; }
/* right: one family draws the whole label */
text { font-family: "Iansui", "TsangerJinKai02", "Source Han Serif SC", "Songti SC", Charter, Georgia, serif; }
```
