...
This configuration fits 2 pages when Iansui is available. Font fallback to TsangerJinKai02 or Source Han Serif adds roughly 0.3pt per line; run `--verify` after any font environment change.
